...
import { useListHotels, getListHotelsQueryKey, useListAllBookings, getListAllBookingsQueryKey, useListUsers, getListUsersQueryKey } from "@workspace/api-client-react";
