...
const team = [
  {
    ...
    role: 'Founder & CEO',
    bio: 'Former hospitality director with 20 years across Parisian palace hotels. Isabelle founded Selora to bring insider access to every traveller.',
    image:
...
const milestones = [
  {
    ...
    description:
      "Selora was born from a simple idea — make the world's best hotels accessible to everyone.",
  },
  {
    year: '2018',
    title: '50 Hotels Milestone',
    description:
      'Expanded our portfolio across Europe, with our first Asian partners joining the collection.',
  },
  {
    year: '2020',
    title: 'Global Reach',
    description:
      'Survived and thrived through challenging times, emerging with a stronger, more diverse portfolio.',
  },
  {
    year: '2022',
    title: 'Award-Winning Platform',
    description:
      'Named Best Luxury Travel Platform by Condé Nast Traveller readers for two consecutive years.',
  },
  {
    year: '2024',
    title: '50,000 Guests Served',
    description:
      'A community of discerning travellers who trust Selora for every extraordinary stay.',
  },
];
    ...
    <Layout>
      ...
      <section className="relative min-h-[520px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-white/85 max-w-2xl mx-auto leading-relaxed">
            Selora was built by travellers, for travellers — with one unwavering
            belief: exceptional hospitality should be within everyone's reach.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Founded in 2016 in Paris, Selora began as a small editorial
                project reviewing the world's finest independent hotels. Today
                we've grown into a trusted booking platform for discerning
                travellers across the globe.
              </p>
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Every property in our collection is personally inspected by our
                curation team. We reject over 80% of hotels that apply to join —
                because your time and money deserve only the best.
              </p>
              <Link href="/hotels">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-background rounded-xl p-4 shadow-xl border border-border max-w-[200px]">
                ...
                <p className="text-xs font-medium text-foreground">
                  "Flawlessly curated — every stay has been unforgettable."
                </p>
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <p className="text-primary text-sm font-semibold uppercase tracking-widest mb-3">
              The People Behind Selora
            </p>
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground">
              Meet the Team
            </h2>
            <p className="text-muted-foreground mt-4 max-w-xl mx-auto text-lg">
              Hospitality veterans, travel writers and experience designers —
              united by an obsession with the perfect stay.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
