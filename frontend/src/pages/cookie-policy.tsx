...
const cookieTypes = [
  {
    ...
    description:
      'These cookies are strictly necessary for the Selora platform to function. They enable core features such as authentication, session management, security, and booking checkout. You cannot opt out of essential cookies — without them, the website cannot operate.',
    examples: [
      {
        name: 'session_id',
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        ...
        purpose: 'Opt-out flag for internal analytics',
        duration: 'Persistent',
      },
    ],
  },
    ...
    examples: [
      {
        ...
        purpose: 'Saves your selected currency',
        duration: '12 months',
      },
      {
        name: 'theme',
      ...
      {
        name: 'search_filters',
        purpose: 'Retains your last hotel search settings',
        duration: '30 days',
      },
    ],
  },
  {
    ...
    description:
      'Selora does not use third-party advertising cookies or tracking pixels for retargeting purposes. We do not share your browsing behaviour with ad networks. You will not see Selora ads following you around the internet as a result of cookies set on our platform.',
    examples: [],
  },
];
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground leading-relaxed mb-3">
                This Cookie Policy explains what cookies Selora uses, why we use
                them, and how you can control them. We believe in full
                transparency — you should always know what's running on your
                device and why.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                We only use cookies that are necessary for our platform to work,
                to improve your experience, and to understand how people use
                Selora. We never use advertising or tracking cookies.
              </p>
            </div>
            <div className="space-y-3">
              {[
                {
                  icon: ShieldCheck,
                  text: 'Essential cookies only — no ad tracking',
                },
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Here is a complete breakdown of every category of cookie on our
              platform — including what we don't use.
            </p>
          </div>
          <div className="space-y-6">
            {cookieTypes.map(
              ({
                ...
                <div
                  key={title}
                  className={`rounded-2xl border p-7 ${border} ${bg}`}
                >
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mt-10 bg-background border border-border/50 rounded-2xl p-6">
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              or write to us at Selora SAS, 14 Rue du Faubourg Saint-Honoré,
              75008 Paris, France.
            </p>
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                description:
                  'The rules governing your use of the Selora platform.',
              },
              {
                href: '/safety',
                icon: ShieldCheck,
        ...
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <div className="bg-background border border-border/50 rounded-3xl p-12 shadow-sm">
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Your privacy is built into everything we do. Explore our
              collection of luxury hotels knowing we respect your data.
            </p>
