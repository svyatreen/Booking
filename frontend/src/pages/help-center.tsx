...
const categories = [
  ...
  },
  {
    icon: ShieldCheck,
    label: "Safety",
    color: "bg-stone-100 text-stone-600 dark:bg-stone-900/30 dark:text-stone-300",
    count: 4,
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Most hotels on StayLux allow bookings up to 12 months in advance. Some exclusive properties offer up to 18 months. For popular dates (Christmas, New Year, major events), we strongly recommend booking as early as possible.",
  },
  {
    category: "Payments",
  ...
  },
  {
    ...
    answer:
      "Absolutely. StayLux is PCI-DSS compliant and all payments are processed through our certified payment partner. Your card details are encrypted end-to-end. We are also 3D Secure enabled for an extra layer of protection.",
  },
  {
  ...
  {
    category: "Safety",
    question: "How does StayLux verify its hotels?",
    answer:
  ...
  return (
    <Layout>
      ...
      <section className="py-16 bg-muted/30 border-b border-border/50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-4">
            {[{ icon: BookOpen, label: "All", color: "bg-primary/10 text-primary", count: faqs.length }, ...categories].map(
                ...
                return (
                  <div
                    ...
                    className={`border rounded-xl overflow-hidden transition-all ${
                      isOpen ? "border-primary/40 shadow-sm" : "border-border/50"
                    } bg-background`}
                  >
                    <button
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="font-semibold text-foreground text-base leading-snug">{faq.question}</p>
                      </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            <p className="text-primary text-sm font-semibold uppercase tracking-widest mb-3">Still Need Help?</p>
            <h2 className="font-serif text-4xl font-bold text-foreground">Contact Our Support Team</h2>
            <p className="text-muted-foreground mt-3 max-w-lg mx-auto">
              Our team of hospitality specialists is available around the clock to assist you.
            </p>
          </div>
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            <div className="bg-background border border-border/50 rounded-2xl p-7 text-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="font-semibold text-foreground text-base mb-2">Live Chat</h3>
              <p className="text-muted-foreground text-sm mb-5 leading-relaxed">
                Chat with a support specialist in real time. Fastest response for urgent queries.
              </p>
            ...
            <div className="bg-background border border-border/50 rounded-2xl p-7 text-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="font-semibold text-foreground text-base mb-2">Email Support</h3>
              <p className="text-muted-foreground text-sm mb-5 leading-relaxed">
                Send us a detailed message and we'll get back to you with a thorough response.
              </p>
              ...
              <Link href="/contact">
                <Button variant="outline" className="w-full rounded-lg">Send Email</Button>
              </Link>
            </div>
            ...
            <div className="bg-background border border-border/50 rounded-2xl p-7 text-center shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="font-semibold text-foreground text-base mb-2">Phone Support</h3>
              <p className="text-muted-foreground text-sm mb-5 leading-relaxed">
                Speak directly with a specialist for complex bookings or urgent travel issues.
              </p>
              <div className="flex items-center justify-center gap-1.5 text-xs text-muted-foreground font-medium mb-5">
                <Clock className="h-3.5 w-3.5" />
                Mon – Sun, 08:00–22:00 CET
              </div>
              <Button variant="outline" className="w-full rounded-lg">+33 1 23 45 67 89</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-background border-t border-border/40">
        <div className="container mx-auto px-4 max-w-5xl">
          <h2 className="font-serif text-2xl font-bold text-foreground mb-8 text-center">Popular Topics</h2>
