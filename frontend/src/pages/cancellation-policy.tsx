      ...
      <section className="relative min-h-[360px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white max-w-2xl">
          ...
          <p className="text-lg text-white/85 leading-relaxed">
            We believe in clarity and fairness. Here's exactly what to expect
            when plans change.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Each hotel sets its own cancellation terms. The applicable policy
              is always shown clearly before you confirm your booking.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {policies.map(
              ({
                ...
                >
                  <div
                    className={`h-12 w-12 rounded-xl bg-background flex items-center justify-center shadow-sm`}
                  >
                  ...
                  <div>
                    ...
                    <p className={`text-sm font-medium ${color} mb-3`}>
                      {subtitle}
                    </p>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              A quick reference to understand what you'll receive depending on
              when you cancel.
            </p>
          </div>
          ...
          <p className="text-xs text-muted-foreground text-center mt-5 leading-relaxed">
            * The exact policy for each booking is always displayed on the hotel
            page and in your booking confirmation. Hotel-specific terms may
            override the above.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                description:
                  "Log in to your Selora account and navigate to 'My Bookings' in your profile menu.",
              },
              {
                step: '02',
                icon: AlertCircle,
                ...
                description:
                  'Find the booking you wish to cancel and click on it to open the booking details.',
              },
              {
                step: '03',
                icon: XCircle,
                ...
                description:
                  "Click 'Cancel Booking' and review the applicable cancellation terms before confirming.",
              },
              {
                step: '04',
                icon: CreditCard,
                ...
                description:
                  'Once confirmed, your refund (if applicable) will be returned to your original payment method.',
              },
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground">
              Everything you need to know about cancelling or modifying a
              booking.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <div className="bg-primary/5 border border-primary/20 rounded-3xl p-12">
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Every Selora booking comes with transparent terms and dedicated
              support. Your peace of mind is our priority.
            </p>
