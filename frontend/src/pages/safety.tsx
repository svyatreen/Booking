...
const commitments = [
  ...
  },
  {
    ...
    description:
      'All guest reviews on Selora are verified as genuine post-stay submissions. We do not allow incentivised or anonymous reviews, so you can trust what you read.',
  },
  {
    icon: Fingerprint,
    title: 'Data Privacy',
...
const guestTips = [
  {
    ...
    description:
      'Always review the refund terms before confirming your booking — policies vary by property.',
  },
  {
    icon: FileText,
    title: 'Keep your confirmation email',
    description:
      'Save your booking confirmation as proof of reservation. It contains all essential check-in details.',
  },
  {
    icon: Wifi,
    title: 'Use secure networks',
    description:
      'Avoid making bookings over public Wi-Fi. Always use a trusted, password-protected connection.',
  },
  {
    icon: PhoneCall,
    title: 'Share your itinerary',
    description:
      'Let a trusted person know your travel plans, hotel address, and check-in dates when travelling alone.',
  },
  {
    icon: AlertTriangle,
    title: 'Report suspicious activity',
    description:
      'If you notice anything unusual about your booking confirmation or our website, contact us immediately.',
  },
  {
    icon: HeartHandshake,
...
const faqs = [
  {
    ...
    answer:
      "Every property listed on Selora is manually verified by our curation team. We conduct on-site inspections, check official registrations, and review licences before any hotel is approved. You'll also see verified guest reviews and a Selora quality badge on all listings.",
  },
  {
  ...
  },
  {
    ...
    answer:
      'If you receive an unsolicited email, call, or message claiming to be from Selora and asking for payment or personal details, do not respond. Contact our support team immediately via the Contact Us page or by calling our fraud hotline: +33 1 23 45 67 89.',
  },
  {
    question: 'How are guest reviews moderated?',
    answer:
      'Reviews are only accepted from guests who have completed a stay booked through Selora. Each review is screened by our trust and safety team before publication. We have a zero-tolerance policy for fake or manipulated reviews.',
  },
  {
      ...
      <section className="relative min-h-[380px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white max-w-2xl">
          ...
          <p className="text-lg text-white/85 leading-relaxed">
            We go above and beyond to make sure every booking, every stay, and
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              From secure payments to verified properties, we've built multiple
              layers of protection into every part of the Selora experience.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-start">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                While we do everything we can to protect you on our platform,
                these simple habits will help keep your travels safe from
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl p-5 flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Selora will never ask for your password, card details, or
                    OTP via email, SMS, or phone. If you receive such a request,
                    it is fraudulent — do not respond and report it to us
                    immediately.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center text-center md:text-left">
              <div className="md:col-span-2">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  If you experience an emergency during your stay, always
                  contact local emergency services first (112 in Europe, 911 in
                  the USA). Our dedicated safety team is also available around
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground">
              Answers to the most frequently asked questions about safety and
              security at Selora.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <div className="bg-background border border-border/50 rounded-3xl p-12 shadow-sm">
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Every Selora property is verified, every payment is encrypted, and
              our team is always on hand. Book knowing we've got your back.
            </p>
