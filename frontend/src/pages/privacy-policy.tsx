  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: 'Selora does not sell, rent, or trade your personal information to any third party for their own marketing or commercial purposes. Period.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "To make a data request, email us at privacy@Selora.com or use the form in your account settings under 'Privacy & Data'. We will respond within 30 days. You also have the right to lodge a complaint with your national data protection authority.",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        text: 'Selora is not intended for use by individuals under the age of 18. We do not knowingly collect personal data from children. If we become aware that a child has provided us with personal information, we will delete it promptly.',
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        text: 'We may update this Privacy Policy from time to time. When we make material changes, we will notify you by email and display a notice on our platform at least 14 days before the changes take effect. Your continued use of Selora after the effective date constitutes acceptance.',
      },
    ],
  },
];
...
const highlights = [
  {
    icon: Lock,
    label: 'No data sold',
    description: 'Your data is never sold to third parties',
  },
  {
    icon: Trash2,
    label: 'Right to delete',
    description: 'Request account deletion at any time',
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: 'Unsubscribe from marketing in one click',
  },
];
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                This Privacy Policy explains what personal data Selora collects,
                how we use it, who we share it with, and what rights you have
                over your information.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                By using Selora, you agree to the practices described in this
                policy. If you have any questions, our privacy team is always
                available at{' '}
                <a
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mt-10 bg-muted/40 border border-border/50 rounded-2xl p-6">
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              This Privacy Policy is governed by the laws of France. Selora SAS,
              14 Rue du Faubourg Saint-Honoré, 75008 Paris, France, is the data
              controller responsible for your personal information. Our EU Data
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  To access, correct, export, or delete your personal data — or
                  to withdraw consent — contact our privacy team. We'll respond
                  within 30 days.
                </p>
        ...
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <div className="bg-primary/5 border border-primary/20 rounded-3xl p-12">
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Your privacy matters to us. Explore our curated collection of
              luxury hotels knowing your data is safe and your rights are always
              respected.
            </p>
