...
const featuredCoverage = [
  {
    ...
    excerpt:
      'Selora stands out from the crowd with its obsessive focus on curation — only the finest independent and boutique properties make the cut, making every search feel effortless.',
    url: '#',
    tag: 'Featured',
  },
  {
    ...
    color: 'bg-blue-900',
    date: 'January 2025',
    title: 'How Selora Is Redefining Luxury Hotel Discovery',
    excerpt:
      'In an era of endless choice, Selora has taken the opposite approach: radical curation. The result is a platform where every listed property is genuinely worth your time and money.',
    url: '#',
    tag: 'Cover Story',
  },
  {
    ...
    excerpt:
      'Unlike aggregators that list everything under the sun, Selora curates with conviction. Their rejection rate of over 80% is the highest in the industry — and guests feel the difference.',
    url: '#',
    tag: 'Review',
  },
];
...
const pressReleases = [
  {
    date: 'April 2025',
    title: 'Selora Surpasses 50,000 Guests Served Worldwide',
    summary:
      'The luxury travel platform celebrates a major milestone as it continues global expansion.',
  },
  {
    date: 'February 2025',
    title: 'Selora Launches Sustainable Travel Initiative',
    summary:
      'New eco-certification badge programme highlights environmentally responsible properties across the portfolio.',
  },
  {
    date: 'December 2024',
    title: "Selora Named Best Luxury Booking Platform — Readers' Choice 2024",
    summary:
      "Condé Nast Traveller Readers' Choice Awards recognise Selora for the second consecutive year.",
  },
  {
    date: 'September 2024',
    title: 'Selora Expands to Southeast Asia with 12 New Properties',
    summary:
      "Singapore, Bali, and Bangkok welcome the platform's signature curated approach to luxury accommodation.",
  },
  {
    date: 'June 2024',
    title: 'Selora Partners with Relais & Châteaux',
    summary:
      'Strategic partnership brings 30 iconic Relais & Châteaux properties exclusively to the Selora platform.',
  },
  {
    date: 'March 2024',
    title: 'Selora Raises Series B to Accelerate Global Curation',
    summary:
      '€24M funding round led by European luxury fund to expand the curation team and technology platform.',
  },
];
...
const awards = [
  {
    year: '2025',
    award: 'Best Luxury Travel Platform',
    body: 'World Travel Awards',
  },
  {
    year: '2024',
    award: "Readers' Choice — Best Hotel Booking",
    body: 'Condé Nast Traveller',
  },
  { year: '2024', award: 'Top 50 Travel Innovators', body: 'Skift' },
  { year: '2023', award: "Editor's Pick — Luxury Tech", body: 'Wallpaper*' },
  {
    year: '2023',
    award: 'Best User Experience — Travel',
    body: 'Webby Awards',
  },
  {
    year: '2022',
    award: 'Rising Star in Luxury Hospitality',
    body: 'Hospitality Tech Europe',
  },
];
      ...
      <section className="relative min-h-[420px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white max-w-3xl">
          ...
          <p className="text-lg text-white/85 leading-relaxed max-w-xl mx-auto">
            The world's leading travel publications trust Selora. Find our
            latest coverage, press releases, awards and media resources all in
            one place.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featuredCoverage.map(
              ({ outlet, logo, color, date, title, excerpt, url, tag }) => (
                <div
                  key={outlet}
                ...
                >
                  <div
                    className={`${color} px-6 py-5 flex items-center justify-between`}
                  >
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Journalists and media professionals can download our complete
                brand assets, including high-resolution logos, product
                screenshots, and executive portraits.
              </p>
        ...
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <div className="bg-primary/5 border border-primary/20 rounded-3xl p-12">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8 max-w-lg mx-auto">
              Our communications team is available for interviews, comments, and
              media partnerships. We aim to respond to all press enquiries
              within 24 hours.
            </p>
