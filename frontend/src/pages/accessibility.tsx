...
const commitments = [
  {
    ...
    features: ["AA contrast compliance", "Full alt text coverage", "200% zoom support", "Dark mode"],
  },
  {
    icon: Ear,
    ...
    features: ["No audio-only content", "Visual alert alternatives", "No auto-play sound", "Captions on video"],
  },
  {
    icon: MousePointer2,
    title: "Motor & Navigation",
    description:
      "Every feature on StayLux is accessible via keyboard navigation alone. We use logical tab order, visible focus indicators, and skip-to-content links. All interactive elements have a minimum touch target of 44×44px.",
    features: ["Full keyboard navigation", "Visible focus rings", "Skip-to-content links", "44px touch targets"],
  },
  {
    icon: Brain,
    ...
    features: ["Plain language", "Descriptive error messages", "No time pressure", "Consistent layouts"],
  },
  {
    icon: Monitor,
    title: "Screen Reader Support",
    description:
      "StayLux is built with semantic HTML and ARIA landmarks so screen readers can interpret every page correctly. We test regularly with NVDA, JAWS, and VoiceOver across desktop and mobile platforms.",
    features: ["Semantic HTML", "ARIA landmarks", "NVDA & JAWS tested", "VoiceOver compatible"],
  },
  {
    icon: Smartphone,
    ...
    features: ["iOS VoiceOver ready", "Android TalkBack ready", "Responsive text reflow", "No gesture-only actions"],
  },
];
...
const standards = [
  {
    ...
    description: "Our target conformance level for all new and updated features on the StayLux platform.",
  ...
  },
  {
    ...
    description: "The EU standard for ICT accessibility, aligned with WCAG 2.1 AA, applicable to our EU user base.",
    status: "Compliant",
    statusColor: "text-green-700 dark:text-green-400 bg-green-100 dark:bg-green-900/30",
  },
  {
    code: "ARIA 1.2",
    title: "Accessible Rich Internet Applications",
    description: "We follow WAI-ARIA 1.2 specifications for dynamic and interactive content throughout the platform.",
    status: "Implemented",
    statusColor: "text-green-700 dark:text-green-400 bg-green-100 dark:bg-green-900/30",
  },
  {
    ...
    description: "We align with Section 508 requirements to serve users in the United States, including those using assistive technologies.",
    status: "Aligned",
    statusColor: "text-green-700 dark:text-green-400 bg-green-100 dark:bg-green-900/30",
  },
];
...
const hotelFeatures = [
  ...
  { icon: CheckCircle2, text: "Accessible bathrooms with grab rails and roll-in showers" },
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Please use our Accessibility Feedback form below or email us at accessibility@staylux.com. Include a description of the issue, the page or feature affected, and the assistive technology you are using. We aim to acknowledge all reports within 2 business days and resolve critical issues within 14 days.",
  },
];
  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[380px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white max-w-2xl">
          ...
          <p className="text-lg text-white/85 leading-relaxed">
            StayLux is built for everyone. We are committed to making luxury travel accessible to all guests, regardless of disability or assistive technology.
          </p>
        </div>
      </section>
      ...
      <section className="bg-primary text-primary-foreground py-12">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { icon: CheckCircle2, value: "WCAG 2.1", label: "Target AA level" },
              { icon: Monitor, value: "3", label: "Screen readers tested" },
              { icon: Globe2, value: "EN 301 549", label: "EU compliant" },
              { icon: HeartHandshake, value: "24/7", label: "Accessibility support" },
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                We believe that exceptional hospitality must be inclusive. Whether you use a screen reader, navigate by keyboard, or require specific hotel facilities, StayLux is designed to support you at every step.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-5">
                Our engineering and design teams follow accessibility best practices from the first line of code. We test with real assistive technologies and consult with users who have disabilities to continuously improve our platform.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                This is an ongoing commitment. If something doesn't work for you, we want to know — and we will fix it.
              </p>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-5 -left-5 bg-background rounded-xl p-4 shadow-xl border border-border max-w-[210px]">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-foreground text-sm">Inclusive First</span>
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed">Accessibility is a core design principle, not an afterthought.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              From screen readers to motor navigation, we've addressed the full spectrum of accessibility needs across our platform.
            </p>
          </div>
            ...
            {commitments.map(({ icon: Icon, title, description, features }) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {features.map((f) => (
                    <span key={f} className="text-xs bg-primary/8 text-primary font-medium px-2.5 py-1 rounded-full border border-primary/15">
                      {f}
                    </span>
                  ))}
                </div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-14">
            <p className="text-primary text-sm font-semibold uppercase tracking-widest mb-3">Compliance</p>
            <h2 className="font-serif text-4xl font-bold text-foreground mb-4">Standards We Follow</h2>
            <p className="text-muted-foreground max-w-lg mx-auto">
              Our accessibility programme is benchmarked against the leading international standards for digital inclusion.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 gap-5">
            {standards.map(({ code, title, description, status, statusColor }) => (
              <div
                key={code}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    ...
                    <span className={`text-xs font-semibold px-2.5 py-0.5 rounded-full ${statusColor}`}>{status}</span>
                  </div>
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-14 items-start">
            <div>
              <p className="text-primary text-sm font-semibold uppercase tracking-widest mb-3">At Our Hotels</p>
              <h2 className="font-serif text-4xl font-bold text-foreground mb-5 leading-tight">
                Accessible Hotel Features
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-5">
                We clearly display accessibility information for every hotel in our collection. Our hotel partners provide details on physical access, assistive facilities, and services available to guests with disabilities.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                If you need specific facilities not listed on a hotel page, contact our support team before booking. We will verify directly with the property and help you find the best match for your needs.
              </p>
              <Link href="/contact">
            ...
            <div className="space-y-3">
              {hotelFeatures.map(({ icon: Icon, text }) => (
                <div key={text} className="flex items-center gap-3 bg-background border border-border/50 rounded-xl px-5 py-3.5 shadow-sm">
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl p-8">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-semibold text-foreground text-lg mb-2">Known Limitations & Ongoing Work</h3>
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  While we strive for full WCAG 2.1 AA compliance, some areas of our platform are still being improved. Current known limitations include: complex date picker interactions on older browsers, some third-party map embeds that lack full screen reader support, and certain PDF documents that are not yet screen-reader optimised.
                </p>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  We are actively working to resolve all known issues. If you encounter a barrier not listed here, please report it — your feedback directly shapes our accessibility roadmap.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-14">
            ...
            <h2 className="font-serif text-4xl font-bold text-foreground mb-4">Accessibility FAQs</h2>
            <p className="text-muted-foreground">
              Answers to the most common questions about accessibility on our platform and at our hotels.
            </p>
          </div>
          <div className="space-y-3">
            {faqs.map((faq) => (
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center text-center md:text-left">
              <div className="md:col-span-2">
                <div className="flex items-center gap-3 mb-4 justify-center md:justify-start">
                  ...
                  <h3 className="font-semibold text-foreground text-lg">Send Us Accessibility Feedback</h3>
                </div>
                <p className="text-muted-foreground text-sm leading-relaxed mb-3">
                  Found a barrier? Something that doesn't work with your assistive technology? We want to hear from you. Every report helps us build a more inclusive platform for everyone.
                </p>
        ...
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <div className="bg-primary/5 border border-primary/20 rounded-3xl p-12">
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Browse our collection of 43+ verified luxury hotels, filtered by the accessibility features that matter most to you.
            </p>
